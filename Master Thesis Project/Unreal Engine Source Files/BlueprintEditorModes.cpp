	...
	: FApplicationMode(InModeName, GetLocalizedMode)
{
	...
	BlueprintEditorTabFactories.RegisterFactory(MakeShareable(new FBlueprintAlternativeSummoner(InBlueprintEditor)));
	...
	: FApplicationMode(FBlueprintEditorApplicationModes::BlueprintInterfaceMode, FBlueprintEditorApplicationModes::GetLocalizedMode)
{
	...
	BlueprintInterfaceTabFactories.RegisterFactory(MakeShareable(new FBlueprintAlternativeSummoner(InBlueprintEditor)));
			...
			(
				...
				(
					...
					(
						...
						->AddTab( FBlueprintEditorTabs::CompilerResultsID, ETabState::ClosedTab )
						->AddTab( FBlueprintEditorTabs::FindResultsID, ETabState::ClosedTab )
						->AddTab( FBlueprintEditorTabs::BlueprintAlternativesID, ETabState::ClosedTab)
					)
				)
				->Split
				(
	...
	: FApplicationMode(FBlueprintEditorApplicationModes::BlueprintMacroMode, FBlueprintEditorApplicationModes::GetLocalizedMode)
{
	...
	BlueprintMacroTabFactories.RegisterFactory(MakeShareable(new FBlueprintAlternativeSummoner(InBlueprintEditor)));
