...
{
	// Blueprint Alternatives Comamands
	UI_COMMAND( SaveAlternative, "Save Alternative", "Saves Current Blueprint as an alternative", EUserInterfaceActionType::Button, FInputChord() );
	UI_COMMAND( LoadAlternative, "Load Alternative", "Loads Blueprint Alternative into current blueprint", EUserInterfaceActionType::Button, FInputChord() );
	UI_COMMAND( OpenBlueprintAlternatives, "Blueprint Alternatives", "Open Blueprint Alternatives tab", EUserInterfaceActionType::Button, FInputChord() );
