...
//////////////////////////////////////////////////////////////////////////
// FBlueprintAlternativeSummoner

struct FBlueprintAlternativeSummoner : public FWorkflowTabFactory
{
public:
	FBlueprintAlternativeSummoner(TSharedPtr<class FAssetEditorToolkit> InHostingApp);

	virtual TSharedRef<SWidget> CreateTabBody(const FWorkflowTabSpawnInfo& Info) const override;

	virtual FText GetTabToolTipText(const FWorkflowTabSpawnInfo& Info) const override
	{
		return LOCTEXT("BlueprintAlternativeSummoner", "The blueprint alternative tab shows a list of saved alternatives");
	}
};
