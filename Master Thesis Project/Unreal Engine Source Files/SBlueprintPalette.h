...
/*******************************************************************************
* SBlueprintAlternativesItem
*******************************************************************************/

/** Widget for displaying a single item  */
class SBlueprintAlternativesItem : public SGraphPaletteItem
{
public:
	SLATE_BEGIN_ARGS(SBlueprintAlternativesItem)
		: _ShowClassInTooltip(false)
	{}
...
*******************************************************************************/
//
//class SBlueprintAlternatives : public SCompoundWidget
//{
//public:
...
//	void OnSplitterResized() const;
//
//	TSharedPtr<SListView<TSharedRef<FAlternativeData>>> AlternativeListView;
//
//	TSharedPtr<SWidget> FavoritesWrapper;
//	TSharedPtr<SSplitter> AlternativesSplitter;
//	TSharedPtr<SWidget> LibraryWrapper;
//
//protected:
