...
public:
	...
	TSharedRef<class SBlueprintAlternatives> GetBlueprintAlternatives() const { return BlueprintAlternatives.ToSharedRef(); }
	...
	*/
	...
	void SaveAlternative(bool check);
	void LoadAlternative(bool check);
...
protected:
	...
	/** Save Current Blueprint as an alternative **/
	void SaveAlternative();

	/** Load Desired Blueprint alternative **/
	void LoadAlternative();

	/** Open Blueprint Alternatives tab*/
	void OpenBlueprintAlternatives();
...
protected:
	...
	/** Show Alternatives in a tab */
	TSharedPtr<class SBlueprintAlternatives> BlueprintAlternatives;
	...
	/** Alternatives saves **/
	FString Alternatives[10];

	/** Current graph nodes **/
	FString CurrentNodes;

	/** Current Alternative Index **/
	int CurrentAlt = 0;

	/** Total Number of Alternatives Saved **/
	int AltCount = 0;;
